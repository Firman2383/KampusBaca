...
<!-- Mirrored from admin.pixelstrap.com/universal/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 May 2025 13:42:15 GMT -->
<head>
                ...
                <ul class="nav-menus">
                    ...
                    <li>
                        <a href="#!" onclick="javascript:toggleFullScreen()" class="text-dark">
                            <img class="align-self-center pull-right me-2" src="{{ asset('') }}assets/images/dashboard/browser.png" alt="header-browser">
                        </a>
                    </li>
                    <li class="onhover-dropdown">
                        <a href="#!" class="txt-dark">
                            <img class="align-self-center pull-right me-2" src="{{ asset('') }}assets/images/dashboard/translate.png" alt="header-translate">
                        </a>
                    ...
                    <li class="onhover-dropdown">
                        <a href="#!" class="txt-dark">
                            <img class="align-self-center pull-right me-2" src="{{ asset('') }}assets/images/dashboard/notification.png" alt="header-notification">
    ...
    <div class="page-body-wrapper">
        ...
        <div class="page-sidebar custom-scrollbar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="https://admin.pixelstrap.com/universal/starter-kit/layout-light.html" class="sidebar-header">
                ...
                <li>
                    ...
                    <ul class="sidebar-submenu">
                        ...
                        <li><a href="fix-header%26sidebar.html"><i class="fa fa-angle-right"></i>Fix Header & sidebar</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sidebar-submenu">
                        ...
                        <li>
                            <a href="javascript:void(0)"><i class="fa fa-angle-right"></i>Tabs<i class="fa fa-angle-down pull-right"></i></a>
                            <ul class="sidebar-submenu">
                ...
                <li>
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="javascript:void(0)"><i class="fa fa-angle-right"></i>Form Controls<i class="fa fa-angle-down pull-right"></i></a>
                            <ul class="sidebar-submenu">
                        ...
                        <li>
                            <a href="javascript:void(0)"><i class="fa fa-angle-right"></i>Form Widgets<i class="fa fa-angle-down pull-right"></i></a>
                            <ul class="sidebar-submenu">
                        ...
                        <li>
                            <a href="javascript:void(0)"><i class="fa fa-angle-right"></i>Form Layout<i class="fa fa-angle-down pull-right"></i></a>
                            <ul class="sidebar-submenu">
                ...
                <li>
                    <a href="https://admin.pixelstrap.com/universal/index.html" class="sidebar-header">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-center">
                                                        <div class="media d-inline-flex">
                                                            <img class="me-3 img-60" src="{{ asset('') }}assets/images/dashboard/boy-1.png" alt="Generic placeholder image">
                                                            <div class="align-self-center">
                                                                <div>
...
<!-- Mirrored from admin.pixelstrap.com/universal/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 May 2025 13:43:30 GMT -->
</html>
